...
#include "hexapod_interfaces/msg/detail/point_array__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_hexapod_interfaces
...
using _PointArray__ros_msg_type = hexapod_interfaces__msg__PointArray;
...
size_t get_serialized_size_hexapod_interfaces__msg__PointArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointArray__ros_msg_type * ros_message = static_cast<const _PointArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PointArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_interfaces__msg__PointArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hexapod_interfaces
size_t max_serialized_size_hexapod_interfaces__msg__PointArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_interfaces__msg__PointArray;
    is_plain =
      (
...
static size_t _PointArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_interfaces__msg__PointArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, msg, PointArray)() {
