...
bool hexapod_interfaces__msg__point_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hexapod_interfaces.msg._point_array.PointArray", full_classname_dest, 46) == 0);
  }
  hexapod_interfaces__msg__PointArray * ros_message = _ros_message;
  {  // points
...
PyObject * hexapod_interfaces__msg__point_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hexapod_interfaces.msg._point_array");
