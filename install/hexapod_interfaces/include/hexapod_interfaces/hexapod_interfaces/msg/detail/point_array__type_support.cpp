...
{
  new (message_memory) hexapod_interfaces::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hexapod_interfaces::msg::PointArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    offsetof(hexapod_interfaces::msg::PointArray, points),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArray_message_members = {
  ...
  1,  // number of fields
  sizeof(hexapod_interfaces::msg::PointArray),
...
{
  return &::hexapod_interfaces::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hexapod_interfaces, msg, PointArray)() {
  return &::hexapod_interfaces::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
