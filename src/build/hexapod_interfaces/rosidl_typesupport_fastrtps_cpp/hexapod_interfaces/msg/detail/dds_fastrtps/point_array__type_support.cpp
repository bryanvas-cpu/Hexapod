...
#include "hexapod_interfaces/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hexapod_interfaces::msg::PointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hexapod_interfaces::msg::PointArray & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_interfaces::msg::PointArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hexapod_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hexapod_interfaces::msg::PointArray *>(
    untyped_ros_message);
...
{
  return &hexapod_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexapod_interfaces, msg, PointArray)() {
  return &hexapod_interfaces::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
