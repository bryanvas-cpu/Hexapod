...
: ${AMENT_CURRENT_PREFIX:="/home/bryan/hexapod_ws/src/install/hexapod_utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_utils/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_utils/environment/path.sh"
