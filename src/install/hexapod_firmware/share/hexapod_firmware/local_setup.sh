...
: ${AMENT_CURRENT_PREFIX:="/home/bryan/hexapod_ws/src/install/hexapod_firmware"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_firmware/environment/library_path.sh"
